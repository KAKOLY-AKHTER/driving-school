...
export function socialPlatformLabel(platform) {
  return SOCIAL_PLATFORMS.find(p => p.value === platform)?.label || platform || 'Link'
}
...
export function socialIcon(platform, size = 18) {
  switch (platform) {
    ...
    case 'linkedin':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
          <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4V9h4v1.5A6 6 0 0116 8zM6 9H2v12h4zM4 6a2 2 0 110-4 2 2 0 010 4z" />
        </svg>
      )
    case 'whatsapp':
      return (
