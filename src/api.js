...
export const api = {
  ...
  adminCloseDates: (dates) => request('/api/admin/closed-dates', { method: 'POST', body: JSON.stringify({ dates }) }),
  adminReopenDate: (date) => request(`/api/admin/closed-dates/${pathPart(date)}`, { method: 'DELETE' }),
