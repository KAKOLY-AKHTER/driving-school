...
const DARK = '#0a1628'
const PACKAGE_DISPLAY_ORDER = ['2', '3', '5', '4', '12']
const formatPackagePrice = value => `$${priceNumber(value).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`
...
const PACKAGES = [
  ...
  {
    id: 4, name: 'Ideal', subtitle: 'Ideal for Students', hours: '6 Hours',
  ...
  {
    id: 5, name: 'Premier', subtitle: 'Package C', hours: '10 Hours',
...
export default function SchedulePage() {
  ...
  const packages = useMemo(() => [...PACKAGES]
    .sort((a, b) => PACKAGE_DISPLAY_ORDER.indexOf(String(a.id)) - PACKAGE_DISPLAY_ORDER.indexOf(String(b.id)))
    .map(pkg => {
    ...
    return {
      ...
      price: formatPackagePrice(nearPrice),
      longPrice: formatPackagePrice(longPrice),
