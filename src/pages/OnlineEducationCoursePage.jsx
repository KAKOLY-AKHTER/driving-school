...
import { GravityLesson } from '../components/online-course/ChapterThreeLessons'
  ...
  return (
    <div className="oe-course-page">
      <style>{`
        ...
        @media(max-width:700px){.oe-vision-media-left,.oe-vision-media-right,.oe-sunglasses-intro,.oe-hearing-intro,.oe-attitude-intro,.oe-attitude-media,.oe-attitude-media-compact,.oe-behavior-feature,.oe-behavior-media-row,.oe-gravity-media-row,.oe-gravity-media-row.oe-downhill-row,.oe-incline-media-row,.oe-incline-media-wide{grid-template-columns:1fr}.oe-vision-media>img{width:min(220px,80%);max-height:230px}.oe-sunglasses-intro{gap:.8rem}.oe-glasses-stack{grid-template-columns:repeat(3,1fr);gap:.35rem}.oe-glasses-stack img{width:min(110px,100%)}.oe-vision-symptoms{grid-template-columns:repeat(2,minmax(0,1fr))}.oe-hearing-condition-grid,.oe-condition-grid{grid-template-columns:1fr}.oe-condition-card:last-child{grid-column:auto}.oe-hearing-intro{gap:.8rem}.oe-hearing-intro>img{width:190px;max-height:205px}.oe-attitude-intro,.oe-attitude-media{gap:.8rem}.oe-attitude-intro img{width:155px;max-height:155px}.oe-attitude-media img,.oe-attitude-media-compact img{width:min(145px,72%);max-height:145px}.oe-attitude-factor-list,.oe-reckless-injuries{grid-template-columns:1fr}.oe-behavior-feature,.oe-behavior-media-row,.oe-gravity-media-row,.oe-incline-media-row{gap:.75rem}.oe-behavior-feature img,.oe-behavior-media-row img{width:min(160px,70%);max-height:165px}.oe-gravity-media-row img,.oe-gravity-media-row.oe-downhill-row img{width:min(180px,75%);max-height:190px}.oe-incline-media-row img,.oe-incline-media-wide img{width:min(205px,78%);max-height:235px}}
