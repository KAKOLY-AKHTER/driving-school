  ...
  return (
    <div className="oe-course-page">
      <style>{`
        ...
        .oe-course-header{background:linear-gradient(100deg,#3677c6,#4b8bd4);border-bottom:1px solid rgba(255,255,255,.18)}.oe-course-head-inner{width:min(1200px,calc(100% - 2rem));height:84px;margin:auto;display:flex;align-items:center;justify-content:space-between;gap:2rem}.oe-course-logo{display:block;width:185px;max-height:58px;object-fit:contain}.oe-logout{min-height:38px;padding:.55rem 1rem;border:1px solid rgba(255,255,255,.8);border-radius:6px;background:#b91c1c;color:#fff;font:800 .72rem var(--font-mono);letter-spacing:.06em;cursor:pointer;box-shadow:0 5px 14px rgba(72,10,10,.2)}
        ...
        .oe-lesson-title{margin:0;padding:.85rem 1.2rem;background:#0733a0;color:#fff;font-family:var(--font-display);font-size:1.08rem}.oe-lesson-body{padding:clamp(1.2rem,3vw,2rem);background:#f9fafb;min-height:520px}.oe-chapter-kicker{margin:0 0 .8rem;color:#0145a8;font-family:var(--font-display);font-size:clamp(1.25rem,2.5vw,1.8rem);font-style:italic}.oe-intro{font-weight:800;font-size:1rem}.oe-responsibility{width:130px;height:130px;margin:1.3rem auto;border-radius:50%;display:grid;place-items:center;background:radial-gradient(circle at 35% 30%,#68b9ff,#0569bd 58%,#043b77);color:#fff;text-align:center;font:900 .72rem var(--font-mono);letter-spacing:.08em;box-shadow:0 15px 30px rgba(1,69,168,.2)}.oe-points{max-width:760px;margin:1rem auto;line-height:1.6}.oe-lesson-position{text-align:center;color:#637892;font:700 .68rem var(--font-mono);letter-spacing:.08em;text-transform:uppercase}.oe-start-wrap{text-align:center;margin-top:1.6rem}.oe-start{padding:.78rem 1.15rem;border:0;border-radius:6px;background:#273242;color:#fff;font-weight:800;cursor:pointer}.oe-start.started{background:#15803d}.oe-lesson-note{max-width:760px;margin:1rem auto 0;padding:.85rem 1rem;border:1px solid #bbf7d0;border-radius:7px;background:#f0fdf4;color:#166534;text-align:center}.oe-course-footer{padding:1rem;background:#0733a0;color:#dbeafe;text-align:center;font-size:.78rem}
        @media(max-width:900px){.oe-course-head-inner{height:76px}.oe-course-logo{width:165px;max-height:52px}.oe-course-layout{grid-template-columns:1fr}.oe-lesson-body{min-height:auto}.oe-course-nav-inner{overflow-x:auto}.oe-course-nav a,.oe-course-nav button{white-space:nowrap}}
        @media(max-width:520px){.oe-course-head-inner{height:70px}.oe-course-logo{width:145px;max-height:46px}.oe-logout{min-height:34px;padding:.45rem .7rem}.oe-course-layout{width:min(100% - 1rem,1200px)}.oe-lesson-body{padding:1rem}}
      `}</style>
      <header className="oe-course-header"><div className="oe-course-head-inner"><img className="oe-course-logo" src="/hero-icon-logo.png" alt="A Precision Driving School" /><button className="oe-logout" type="button" onClick={handleLogout}>Log Out</button></div></header>
