    ...
    <div className="oe-course-page">
      ...
      <main className="oe-course-layout">
        ...
        <section className="oe-lesson-card" aria-live="polite">
          <h2 className="oe-lesson-title">{isChapterOneTest ? '30 Hour Drivers Ed Curriculum' : activeChapter === 1 || activeChapter === 2 ? "Driver's License: A Privilege" : chapter.lesson}</h2>
