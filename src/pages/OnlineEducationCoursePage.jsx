...
import { TrafficSignsShapesColorsLesson } from '../components/online-course/ChapterFourLessons'
...
export default function OnlineEducationCoursePage() {
  ...
  const isDetailedLesson = isDriverLicenseLesson || isObeyingLawsLesson || isImportanceLesson || isNewLawsLesson || isSmokeFreeLesson || isAutomobileHistoryLesson || isChapterOneTest || isEyesVisionLesson || isEarsHearingLesson || isLimitingConditionsLesson || isEssentialAttitudesLesson || isUndesirableBehaviorsLesson || isChapterTwoTest || isGravityLesson || isInertiaEnergyLesson || isMomentumFrictionLesson || isCentrifugalForceLesson || isChapterThreeTest || isTrafficSignsShapesColorsLesson
