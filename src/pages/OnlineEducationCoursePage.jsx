...
import { EssentialAttitudesLesson, EyesVisionLesson, LimitingPhysicalConditionsLesson } from '../components/online-course/ChapterTwoLessons'
...
export default function OnlineEducationCoursePage() {
  ...
  const isDetailedLesson = isDriverLicenseLesson || isObeyingLawsLesson || isImportanceLesson || isNewLawsLesson || isSmokeFreeLesson || isAutomobileHistoryLesson || isChapterOneTest || isEyesVisionLesson || isLimitingConditionsLesson || isEssentialAttitudesLesson
  ...
  return (
    <div className="oe-course-page">
      <style>{`
        ...
        @media(max-width:700px){.oe-vision-media-left,.oe-vision-media-right,.oe-sunglasses-intro,.oe-attitude-intro,.oe-attitude-media,.oe-attitude-media-compact{grid-template-columns:1fr}.oe-vision-media>img{width:min(220px,80%);max-height:230px}.oe-sunglasses-intro{gap:.8rem}.oe-glasses-stack{grid-template-columns:repeat(3,1fr);gap:.35rem}.oe-glasses-stack img{width:min(110px,100%)}.oe-vision-symptoms{grid-template-columns:repeat(2,minmax(0,1fr))}.oe-condition-grid{grid-template-columns:1fr}.oe-condition-card:last-child{grid-column:auto}.oe-attitude-intro,.oe-attitude-media{gap:.8rem}.oe-attitude-intro img{width:155px;max-height:155px}.oe-attitude-media img,.oe-attitude-media-compact img{width:min(145px,72%);max-height:145px}.oe-attitude-factor-list{grid-template-columns:1fr}}
