...
export default function OnlineEducationCoursePage() {
  ...
  const isDetailedLesson = isDriverLicenseLesson || isObeyingLawsLesson || isImportanceLesson || isNewLawsLesson || isSmokeFreeLesson || isAutomobileHistoryLesson || isChapterOneTest
