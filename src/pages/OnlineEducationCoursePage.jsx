...
import { TrafficControlSignsLesson, TrafficRegulatorySignsLesson, TrafficSignsShapesColorsLesson } from '../components/online-course/ChapterFourLessons'
  ...
  return (
    <div className="oe-course-page">
      <style>{`
        ...
        .oe-regulatory-intro{display:grid;grid-template-columns:minmax(0,1fr) 390px;align-items:center;gap:1.3rem;margin:1.15rem 0;padding:1.15rem;border-radius:11px;background:linear-gradient(135deg,#06285f,#0750a8);color:#fff;box-shadow:0 9px 24px rgba(4,31,74,.17)}.oe-regulatory-intro h4{margin:.15rem 0 .4rem;color:#fff;font-family:var(--font-display);font-size:1.2rem}.oe-regulatory-intro p{margin:.25rem 0;line-height:1.65}.oe-regulatory-eyebrow{color:#ffd75a!important;font:800 .66rem var(--font-mono);letter-spacing:.08em;text-transform:uppercase}.oe-regulatory-intro img{display:block;width:min(370px,100%);max-height:275px;margin:auto;padding:.45rem;border-radius:9px;background:#fff;object-fit:contain;box-shadow:0 8px 18px rgba(0,0,0,.16)}.oe-regulatory-section{margin:1.35rem 0}.oe-regulatory-heading{display:flex;align-items:center;gap:.8rem;margin-bottom:.85rem}.oe-regulatory-heading>span{display:grid;place-items:center;width:40px;height:40px;flex:0 0 auto;border-radius:50%;background:#c51d2a;color:#fff;font:900 .72rem var(--font-mono);box-shadow:0 0 0 4px #fde6e8}.oe-regulatory-heading.yellow>span{background:#d49e00;box-shadow:0 0 0 4px #fff0b8}.oe-regulatory-heading.orange>span{background:#e66d09;box-shadow:0 0 0 4px #ffe5d0}.oe-regulatory-heading p{margin:0;color:#8a6500;font:800 .65rem var(--font-mono);letter-spacing:.08em;text-transform:uppercase}.oe-regulatory-heading h4{margin:.05rem 0 0;color:#06285f;font-family:var(--font-display);font-size:1.18rem;font-weight:900}.oe-regulatory-card-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.75rem}.oe-regulatory-card{--reg-accent:#0145a8;display:grid;grid-template-columns:128px minmax(0,1fr);align-items:center;gap:.85rem;min-height:160px;padding:.8rem;border:1px solid #dbe5f1;border-top:4px solid var(--reg-accent);border-radius:9px;background:#fff;box-shadow:0 5px 16px rgba(15,45,82,.05)}.oe-regulatory-card.red{--reg-accent:#c51d2a}.oe-regulatory-card.blue{--reg-accent:#0145a8}.oe-regulatory-image-wrap{display:grid;place-items:center;min-height:125px;padding:.35rem;border-radius:7px;background:#f5f8fc}.oe-regulatory-card img{display:block;width:116px;height:118px;object-fit:contain;filter:drop-shadow(0 6px 9px rgba(15,23,42,.12))}.oe-regulatory-card h5{margin:0 0 .25rem;color:var(--reg-accent);font-size:.94rem;font-weight:900}.oe-regulatory-card p{margin:0;color:#34445a;font-size:.82rem;line-height:1.55}.oe-parking-section{border-left:5px solid #0145a8}.oe-parking-media{display:grid;grid-template-columns:380px minmax(0,1fr);align-items:center;gap:1.1rem;margin-top:.65rem}.oe-parking-media img{display:block;width:min(365px,100%);max-height:175px;margin:auto;padding:.4rem;border:1px solid #dbe5f1;border-radius:8px;background:#fff;object-fit:contain}.oe-parking-media p{margin:.3rem 0;line-height:1.6}.oe-parking-media ul{width:auto;margin:.4rem 0}.oe-pedestrian-safety-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.75rem;margin:1.2rem 0}.oe-pedestrian-safety-grid article{display:grid;grid-template-columns:145px minmax(0,1fr);align-items:center;gap:.8rem;padding:.85rem;border:1px solid #dbe5f1;border-left:5px solid #d3a100;border-radius:9px;background:#fff;box-shadow:0 5px 15px rgba(15,45,82,.05)}.oe-pedestrian-safety-grid img{display:block;width:135px;height:130px;object-fit:contain}.oe-pedestrian-safety-grid h4{margin:0 0 .25rem;color:#06285f;font-size:.96rem}.oe-pedestrian-safety-grid p{margin:0;color:#34445a;line-height:1.55}.oe-warning-intro{display:grid;grid-template-columns:150px minmax(0,1fr);align-items:center;gap:1rem;margin-bottom:.8rem;padding:.8rem 1rem;border:1px solid #f0d372;border-radius:9px;background:linear-gradient(135deg,#fffdf5,#fff7d7)}.oe-warning-intro img{display:block;width:135px;height:125px;margin:auto;object-fit:contain}.oe-warning-intro p{margin:0;color:#493b1d;line-height:1.62}.oe-warning-card-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.7rem}.oe-warning-card{display:grid;grid-template-columns:115px minmax(0,1fr);align-items:center;gap:.75rem;min-height:145px;padding:.75rem;border:1px solid #eadca8;border-radius:9px;background:#fff;box-shadow:0 4px 14px rgba(92,67,4,.05)}.oe-warning-card:last-child{grid-column:1/-1}.oe-warning-card img{display:block;width:102px;height:110px;margin:auto;object-fit:contain;filter:drop-shadow(0 5px 7px rgba(15,23,42,.1))}.oe-warning-card h5{margin:0 0 .2rem;color:#755a00;font-size:.9rem;font-weight:900}.oe-warning-card p{margin:0;color:#3e4652;font-size:.82rem;line-height:1.5}.oe-information-sign-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.8rem;margin:1.25rem 0}.oe-information-sign-grid article{display:grid;grid-template-columns:150px minmax(0,1fr);align-items:center;gap:.9rem;padding:.9rem;border:1px solid #dbe5f1;border-left:5px solid #1471bb;border-radius:9px;background:#fff;box-shadow:0 5px 16px rgba(15,45,82,.05)}.oe-information-image-wrap{display:grid;place-items:center;min-height:145px;padding:.4rem;border-radius:8px;background:#f4f8fd}.oe-information-sign-grid img{display:block;width:135px;height:135px;object-fit:contain}.oe-information-sign-grid h4{margin:.1rem 0 .3rem;color:#06285f;font-size:.96rem}.oe-information-sign-grid p{margin:.25rem 0;color:#34445a;line-height:1.55}.oe-work-zone-section{margin:1.35rem 0;padding:1rem;border:1px solid #f1c398;border-left:5px solid #e66d09;border-radius:10px;background:linear-gradient(135deg,#fffdfa,#fff4e9);box-shadow:0 6px 18px rgba(120,61,5,.06)}.oe-work-zone-signs{display:grid;grid-template-columns:150px minmax(0,1fr) 150px;align-items:center;gap:1rem;padding:.8rem;border-radius:8px;background:#fff}.oe-work-zone-signs img{display:block;width:135px;height:135px;margin:auto;object-fit:contain}.oe-work-zone-signs h5,.oe-work-zone-tips h5{margin:0 0 .25rem;color:#9f4300;font-size:.96rem;font-weight:900}.oe-work-zone-signs p{margin:0;color:#3f4650;line-height:1.6}.oe-work-zone-tips{display:grid;grid-template-columns:250px minmax(0,1fr);align-items:center;gap:1rem;margin-top:.75rem;padding:.9rem;border-radius:8px;background:#fff}.oe-work-zone-tips img{display:block;width:235px;max-height:160px;margin:auto;object-fit:contain}.oe-work-zone-tips ul{width:auto;margin:.3rem 0}.oe-work-zone-tips li{margin:.3rem 0;line-height:1.52}.oe-regulatory-video{width:min(720px,100%);margin:1.5rem auto}
