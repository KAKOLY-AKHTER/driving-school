...
export default function AdminUserDetailsModal({ dialog, onClose, onRetry }) {
  ...
  const profileFields = [
    ...
    ['Primary Payer Name', profile.payerName],
    ['Payer Relationship', profile.payerRelationship],
    ['Primary Payer Phone', profile.payerPhone],
    ['Primary Payer Email', profile.payerEmail],
    ['Payer Secondary Phone', profile.payerSecondaryPhone],
    ['Primary Payer Address', profile.payerAddress],
    ['Payer Permission Given', formatDateTime(profile.payerConsentAt)],
