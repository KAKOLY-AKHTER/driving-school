...
//   { label: 'Register For Online Drivers Ed', href: 'https://www.aprecisiondrivingschool.com/script/register.php', external: true },
//   { label: 'Register For Driving Lessons', href: 'https://www.aprecisiondrivingschool.com/schedule/cart_home.html', external: true },
// ]
...
//         zIndex: 50,
//         backgroundColor: scrolled ? 'rgba(10, 18, 40, 0.96)' : 'transparent',
...
//       {/* Top Contact Bar */}
//       <div style={{
//         backgroundColor: '#1E304D', /* Dark Blue */
//         padding: '0.4rem 0',
//         color: '#ffffff',
...
//                     <a href={l.href} target={l.external ? "_blank" : "_self"} rel={l.external ? "noopener noreferrer" : ""} className={`nav-link-desktop ${l.href.startsWith('#') ? '' : ''}`}>
//                       {l.label}
//                     </a>
//                   ) : (
...
//         }
//         .nav-link-desktop::after { display: none; }
